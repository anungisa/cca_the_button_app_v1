...
export default function SSOLoginButtons({ onSuccess, onError, disabled = false }) {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        const mockUserData = {
          ...
          name: 'Demo User',
          picture: null,
          provider_user_id: `${provider}_123456`
        };
      ...
      // Don't clear loading here - let the timeout handle it for demo
    }
  };
